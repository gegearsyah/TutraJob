-- Complete Seed Data for Inklusif Kerja
-- This file contains all seed data in one place
-- Run after schema.sql

-- ============================================
-- Job Listings (10 jobs)
-- ============================================
...
--        COUNT(CASE WHEN accessibility_level = 'high' THEN 1 END) as high_accessibility,
--        COUNT(CASE WHEN work_arrangement = 'remote' THEN 1 END) as remote_jobs
